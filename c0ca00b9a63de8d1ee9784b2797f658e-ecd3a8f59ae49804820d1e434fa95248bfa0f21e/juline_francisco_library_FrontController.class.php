...
class FrontController
{
    ...
    public function run()
    {
        ...
        if(ctype_alnum($controllerClass) == false)
        {
            ...
            (
                "Invalid controller name : <strong>$controllerClass</strong>"
            );
        }
        ...
        if(method_exists($controller, $method) == false)
        {
            ...
            throw new ErrorException
            (
                'An HTTP request '.$this->http->getRequestMethod().' was , '.
                "but you forgot the method <strong>$method</strong> in the controller ".
